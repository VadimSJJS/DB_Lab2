...
public partial class PharmacyContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer("Server=DESKTOP-LA9KVTH\\SQLEXPRESS;Database=Pharmacy;Trusted_Connection=True; TrustServerCertificate=True;");
